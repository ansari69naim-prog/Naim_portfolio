...
const Home = () => {
  ...
  function handleViewClick(
    ...
    e.preventDefault();
    setPlatformModal({ open: true, project, ios: ios || "#", android: android || "#", logo: logo || "" });
  }
      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <div className="hero-social-icons">
            <a href="https://x.com/ansari69naim" className="hero-social-icon" aria-label="X (Twitter)">
            ...
            <a href="https://www.instagram.com/ansari9051?igsh=MWw4a2w2d2syYmlnNA==" className="hero-social-icon" aria-label="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.linkedin.com/in/naim-uddin-a82a79134/" className="hero-social-icon" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
        ...
        <div className="home-about-content">
          ...
          <div className="home-about-text">
            ...
            <div className="home-stats">
              ...
              <div className="home-stat-item">
                <h3 className="stat-value">1080+</h3>
        ...
        <div className="projects-grid">
          <div className="project-card">
            <div className="project-image">
              <img src="src/assets/images/Frame 37917.png" alt="Flipshotz App" />
          ...
          <div className="project-card">
            <div className="project-image">
              <img src="src/assets/images/App Icon 1024 X 1024.png" alt="Flipshotz App" />
              <div className="project-overlay">
                <a
                  href="#"
                  className="project-link"
                  onClick={(e) =>
                    handleViewClick(e, "Fitness Tracking App", "#", "#", "././images/project2.jpg")
                  }
                >
                  View Project
                </a>
            ...
            <div className="project-info">
              <h3 className="project-title">TacTix App</h3>
               <p className="project-description">
                Mobile app to track workouts, nutrition, and progress with realtime sync via Firebase.
              </p>
          ...
          <div className="project-card">
            <div className="project-image">
              <img src="src/assets/images/customcolor_logo_customcolor_background 1.png" alt="Portfolio Website" />
              <div className="project-overlay">
                <a
                  href="#"
                  className="project-link"
                  onClick={(e) =>
                    handleViewClick(e, "Creative Portfolio", "#", "#", "././images/project3.jpg")
                  }
                >
                  View Project
                </a>
            ...
            <div className="project-info">
              <h3 className="project-title">Creative Portfolio</h3>
               <p className="project-description">
                Personal portfolio showcasing projects, case studies, and interactive UI animations.
              </p>
              <p className="project-tech">React.js • CSS3 • Animation</p>
        ...
        <div className="platform-modal-overlay" onClick={closeModal}>
          <div className="platform-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="platform-buttons">
              <a href={platformModal.ios} target="_blank" rel="noopener noreferrer" className="platform-btn ios">
                iOS
              </a>
              <a href={platformModal.android} target="_blank" rel="noopener noreferrer" className="platform-btn android">
                Android
              </a>
            </div>
